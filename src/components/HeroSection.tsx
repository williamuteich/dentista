          ...
          <div className="space-y-8 fade-in-up">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <br />
                Atendimentos em <span className="text-[hsl(var(--dental-blue))]">Clareamento, Implantes</span> e Estética Dental
              </h1>

              <p className="text-xl text-muted-foreground leading-relaxed">
                Consultório completo e moderno, oferecendo tratamentos em implantes dentários, próteses, estética dental, aparelho dentário, tratamento de canal,
                cirurgia oral menor e reabilitação do sorriso. Estrutura confortável, com salas preparadas para pré e pós-operatório, bloco cirúrgico,
                estacionamento e acessibilidade total para cadeirantes.
              </p>
            </div>
